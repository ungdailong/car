...
<div class="box">
    <h2 style="float:left; width:80%">Danh sách tin tức - sự kiện</h2> <h2 style="float:right; ">  <?php Admin::button('add, delete'); ?> </h2>
        ...
        <table cellspacing="0" cellpadding="0"><!-- Table -->
            <thead>
                <tr class="alt">
                    ...
                    <th><strong>Ngày tạo/Ngày cập nhật</strong></th>
            ...
            <?php if (empty($rows)) { ?>
                ...
                foreach ($rows as $row) {
                    ...
                    if($row['date_update'] > 0)
                    	$update_date = date('d-m-Y',$row['date_update']);
                    $display = $row['hide'];
                    ...
                    <tr>
                        ...
                        <td><?php echo $create_date; ?><?php if(isset($update_date)) echo '/'.$update_date?></td>
